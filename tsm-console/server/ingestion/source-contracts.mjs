...
export const SOURCE_CATALOG = Object.freeze([
  ...
  Object.freeze({ id: 'NOAA-NWPS', authority: 'NOAA/NWS Office of Water Prediction', endpoint: 'https://api.water.noaa.gov/nwps/v1/', cadence: 'real-time', formats: ['JSON'], authorityNote: 'Observed and forecast products remain separate; NWPS is preferred for forecast/category context.' }),
