...
export const SOURCE_CATALOG = Object.freeze([
  ...
  Object.freeze({ id: 'INDIANA-ELEVATION-2016-2020', authority: 'Indiana Geographic Information Office', endpoint: 'https://di-ingov.img.arcgis.com/arcgis/rest/services/DynamicWebMercator/Indiana_2016_2020_Elevation/ImageServer', cadence: 'published-product', formats: ['ImageServer', 'GeoTIFF'], authorityNote: 'Published Indiana elevation product; preserve service metadata and do not infer vertical datum from the service name.' }),
