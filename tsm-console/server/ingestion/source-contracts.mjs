...
export const SOURCE_CATALOG = Object.freeze([
  Object.freeze({ id: 'USGS-NWIS-IV', authority: 'USGS', endpoint: 'https://api.waterdata.usgs.gov/ogcapi/v1/collections/latest-continuous', cadence: 'real-time', formats: ['JSON', 'GeoJSON'], authorityNote: 'Modern USGS Water Data API runtime; legacy WaterServices is compatibility-only.' }),
  ...
  Object.freeze({ id: 'IDNR-BAFL', authority: 'Indiana DNR Division of Water', endpoint: 'https://gisdata.in.gov/server/rest/services/Best_Available_Flood_Hazard_Layer/MapServer', cadence: 'reference', formats: ['JSON', 'GeoJSON', 'PBF'], authorityNote: 'Planning/construction/Indiana Flood Control Act reference; not flood insurance.' }),
  Object.freeze({ id: 'INDIANA-BAFM', authority: 'Indiana DNR Division of Water', endpoint: 'https://gisdata.in.gov/server/rest/services/Best_Available_Flood_Hazard_Layer/MapServer', cadence: 'reference', formats: ['JSON', 'GeoJSON', 'PBF'], authorityNote: 'Explicit current BAFM planning-authority alias.' }),
  Object.freeze({ id: 'INDIANA-GIS', authority: 'Indiana Geographic Information Office', endpoint: 'https://gisdata.in.gov/server/rest/services', cadence: 'reference', formats: ['ArcGIS REST'], authorityNote: 'Statewide Indiana GIS service umbrella; individual services retain their own authority.' }),
  Object.freeze({ id: 'INDIANA-ROADS-CURRENT', authority: 'Indiana Geographic Information Office / Indiana local governments', endpoint: 'https://gisdata.in.gov/server/rest/services/Hosted/Road_Centerlines_of_Indiana_Current/FeatureServer', cadence: 'annual-current', formats: ['JSON', 'GeoJSON', 'PBF'], authorityNote: 'Current statewide road-centerline framework; prefer the Current service for the most recent annual Data Harvest release.' }),

  Object.freeze({ id: 'INDIANA-BUILDING-FOOTPRINTS', authority: 'Indiana Geographic Information Office', endpoint: 'https://gisdata.in.gov/server/rest/services/Hosted/Building_Footprints/FeatureServer', cadence: 'published-product', formats: ['JSON', 'GeoJSON', 'PBF'], authorityNote: 'Indiana Building Footprints 2016-2020; LiDAR-derived/reference geometry, not survey truth.' }),  Object.freeze({ id: 'INDIANA-ADDRESS-POINTS', authority: 'Indiana Geographic Information Office / Indiana local governments', endpoint: 'https://gisdata.in.gov/server/rest/services/Hosted/Address_Points_of_Indiana_Current/FeatureServer', cadence: 'annual-current', formats: ['JSON', 'GeoJSON', 'PBF'], authorityNote: 'Current statewide address-point framework; local-government source data.' }),
  Object.freeze({ id: 'NWS-WEATHER', authority: 'NOAA National Weather Service', endpoint: 'https://api.weather.gov', cadence: 'real-time', formats: ['GeoJSON', 'JSON-LD'], authorityNote: 'Official U.S. weather forecasts, alerts, and observations; rate limits and User-Agent requirements apply.' }),
  ...
  Object.freeze({ id: 'INDIANA-ELEVATION-2016-2020', authority: 'Indiana Geographic Information Office', endpoint: 'https://di-ingov.img.arcgis.com/arcgis/rest/services/DynamicWebMercator/Indiana_2016_2020_DEM/ImageServer', cadence: 'published-product', formats: ['ImageServer', 'GeoTIFF'], authorityNote: 'Published Indiana elevation product; preserve service metadata and do not infer vertical datum from the service name.' }),
  Object.freeze({ id: 'USACE-NLD', authority: 'USACE', endpoint: 'https://levees.sec.usace.army.mil/api-local', cadence: 'reference', formats: ['JSON', 'GeoJSON'], authorityNote: 'Read-only levee Evidence plane; no automatic accreditation decision.' }),
