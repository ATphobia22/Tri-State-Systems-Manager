...
export const POLICIES = [
  ...
  {
    id: 'IL-FLOODWAY-PART-3700',
    jurisdiction: 'Illinois',
    title: 'Illinois construction in floodways',
    citation: '17 Ill. Adm. Code Part 3700',
    source_uri: 'https://www.ilga.gov/agencies/JCAR/EntirePart?titlepart=01703700',
    authority_class: 'REGULATORY',
    rule: 'Part 3700 defines the floodway around a no-more-than-0.1-foot stage increase; context-specific standards elsewhere in the Part must also be evaluated.',
    version: '2026.1',
    human_gate: true,
  },
  {
    id: 'KY-STREAM-CONSTRUCTION-4060',
    jurisdiction: 'Kentucky',
    title: 'Kentucky stream construction criteria',
    citation: '401 KAR 4:060',
    source_uri: 'https://apps.legislature.ky.gov/law/kar/titles/401/004/060/',
    authority_class: 'REGULATORY',
    rule: 'Floodway encroachments generally require licensed-engineer no-impact certification; the regulatory-floodway boundary methodology separately uses a one-foot maximum rise criterion.',
    version: '2026.1',
    human_gate: true,
  },
  {
