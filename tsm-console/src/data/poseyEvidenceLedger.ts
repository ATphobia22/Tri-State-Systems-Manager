...
export const POSEY_EVIDENCE_LEDGER: readonly PoseyEvidenceLedgerEntry[] = [
  ...
  { evidenceId: 'LEGACY-POINT-TWP-PLAT-FIRM-IMAGES', tier: 'tier6_legacy', sourceId: 'USER-PROVIDED-POINT-TWP-PLAT-FIRM-SCANS', status: 'verified', geographicScope: 'Point Township, Posey County, Indiana; T8S-R14W/R15W', regulatoryUse: 'reference', humanReviewRequired: true, lastReviewed: '2026-09-14' },
